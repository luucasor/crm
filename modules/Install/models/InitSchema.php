...
class Install_InitSchema_Model {
	...
	static function registerEntityMethods($adb) {
		...
		//@@Custom
		// Update contact classification when add an new potential
		$emm->addEntityMethod("Potentials","UpdateContactClassification","modules/Potentials/PotentialsHandler.php","Potentials_updateContactClassification");
	}
