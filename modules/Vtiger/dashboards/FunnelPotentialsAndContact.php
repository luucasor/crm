...
class Vtiger_FunnelPotentialsAndContact_Dashboard extends Vtiger_IndexAjax_View {
    ...
    public function process(Vtiger_Request $request) {
        ...
        if (!empty($content)) {
            $viewer->view('dashboards/FunnelPotentialsAndContactContents.tpl', $moduleName);
        } else {
            $viewer->view('dashboards/FunnelPotentialsAndContact.tpl', $moduleName);
        }
    }
}
