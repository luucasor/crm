...
require_once 'include/Webservices/DescribeObject.php';
	...
	function vtws_sync($mtime,$elementType,$syncType='application',$user=''){ //RCY
//RCY	function vtws_sync($mtime,$elementType,$syncType,$user){
...
//RCY		if($applicationSync && !is_admin($user)){
//RCY			throw new WebServiceException(WebServiceErrorCode::$ACCESSDENIED,"Only admin users can perform application sync");
//RCY		}
