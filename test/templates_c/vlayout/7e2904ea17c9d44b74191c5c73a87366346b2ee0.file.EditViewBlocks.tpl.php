<?php /* Smarty version Smarty-3.1.7, created on 2017-06-08 12:22:12
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/vlayout\modules\Potentials\EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:755158a53ed42d8f49-65010564%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7e2904ea17c9d44b74191c5c73a87366346b2ee0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/vlayout\\modules\\Potentials\\EditViewBlocks.tpl',
      1 => 1496892207,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '755158a53ed42d8f49-65010564',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_58a53ed446ecb',
  'variables' => 
  array (
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_58a53ed446ecb')) {function content_58a53ed446ecb($_smarty_tpl) {?>
...
<!-- Código para preencher o nome da oportunidade automaticamente, falta melhoria.
<script>
	$("#Potentials_editView_fieldName_closingdate").on("change", function(){
		var potentialname = $("#Potentials_editView_fieldName_potentialname").val();
		if(potentialname == '' || potentialname == null){
			var contact_name = $("#contact_id_display").val();
			$("#Potentials_editView_fieldName_potentialname").val("Oportunidade - "+contact_name);	
		}
	});
</script>--><?php }} ?>